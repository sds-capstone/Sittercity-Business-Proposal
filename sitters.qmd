...
anova_rating <- aov(sitters_birth_date~sitters_average_rating, data = rating_sitters)
...
```{r}
#logistic regression 
educ_lm <- lm(sitters_birth_date~sitter_profiles_education_completed, data = rating_sitters)
summary(educ_lm)
```
